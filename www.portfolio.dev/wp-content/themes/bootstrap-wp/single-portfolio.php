         ...
         <?php if ( have_posts() ) : while ( have_posts() ) : the_post (); ?>
            ...
            <div class="col-sm-8 portfolio-image">
               <?php
                  ...
                  $thumbnail_url = wp_get_attachment_image_src( $thumbnail_id, 'tumbnail-size', true);
                ?>
            ...
            <div class="col-sm-4">
               ...
               <?php the_content(); ?>
               <p>
                  <a class="btn btn-large btn-primary" href="<?php the_field('link'); ?>">View Final Piece <span class="glyphicon glyphicon-chevron-right"></span></a>
               </p>
            </div>
